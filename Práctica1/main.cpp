...
float turnLight = 0.0f;
float variableSol = 0.0f;
// timing
const int FPS = 60;
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		staticShader.setVec3("pointLight[0].diffuse", glm::vec3(0.0f, 0.0f, turnLight));
		staticShader.setVec3("pointLight[0].specular", glm::vec3(0.0f, 0.0f, 0.0f));
		staticShader.setFloat("pointLight[0].constant", 0.008f); //Potencia de los rayos
		staticShader.setFloat("pointLight[0].linear", 0.009f); //cambio mas fino
		staticShader.setFloat("pointLight[0].quadratic", 0.00032f); //Entre mas pequeño sea este valor, mas viajan los rayos luminosos / cambio brusco

		staticShader.setVec3("pointLight[1].position", glm::vec3(-80.0, 0.0f, 0.0f));
		staticShader.setVec3("pointLight[1].ambient", glm::vec3(0.0f, 0.0f, 0.0f));
		staticShader.setVec3("pointLight[1].diffuse", glm::vec3(r, g, b));
		...
		staticShader.setVec3("pointLight[2].diffuse", glm::vec3(1.0f, 1.0f, 0.0f));
